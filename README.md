...
ZeichnePunkte()<br>pointlist:append(<br>[color=blue, point_size=0.5,point_type=7, points(data)]<br>)$ | funktioniert wir die obigen Befehle, nur werden Punkte gezeichnet.<br>append() … Damit können mehrere Punktlisten zusammengehängt werden|
